    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-display font-bold tracking-tight text-foreground flex items-center gap-2">
          <Trophy className="w-5 h-5 text-amber-400" /> Personal Growth &
          Application Metrics
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <Card className="group glass hover-lift">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div
              className={`flex h-9 w-9 items-center justify-center rounded-xl bg-white/[0.04] border border-white/[0.06] transition-transform duration-300 group-hover:scale-110 ${outlookColor}`}
            >
                    ...
                    if (active && payload && payload.length) {
                      return (
                        <div className="glass-strong rounded-xl p-4 shadow-2xl border border-white/[0.08]">
                          <p className="font-semibold text-foreground mb-2 text-sm tracking-tight">
                            {label}
                          </p>
          ...
          <CardContent>
            <ul className="space-y-4">
              {insights.keyTrends.map((trend, index) => (
                <li
                  key={index}
                  className="flex items-start space-x-3 group/trend cursor-default"
                >
                  ...
                  <span className="text-sm leading-relaxed text-foreground/90 group-hover/trend:text-foreground transition-colors duration-200">
                    {trend}
                  </span>
                </li>
              ))}
